...
$(document).ready(function() {
  ...
  $(function() {
    $('#saveTitleandAbstract').click(function() {
      $('#GLdisplay').removeAttr('hidden');
      $('#glbut').removeAttr('hidden');
	...
	$(function() {
     ...
     $('#DSdisplay').removeAttr('hidden');
     $('#dsbut').removeAttr('hidden');
		 $('#GLdisplay').empty()
...
$(function() {
	$('#experiment_select').click(function() {
		...
		$('#button_for_ao').empty();
		$('#DSdisplay').empty()
    $('#GVdisplay').removeAttr('hidden');
    $('#gvbut').removeAttr('hidden');
    $('#go').removeAttr('hidden');
		$.getJSON('/_ec', {
